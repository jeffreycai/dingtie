...
$perpage = 50;
$total = StXinping::countAll();
$total_page = ceil($total / $perpage);
$html->renderOut('sydneytoday/backend/st_xinping_list', array(
    'objects' => StXinping::findAllWithPage($page, $perpage),
    'current_page' => $page,
